  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (data.events && Array.isArray(data.events)) {
        const formattedItems = data.events.map((event: any, index: number) => ({
          id: `ai-${index}`,
      ...
      if (data.categories && Array.isArray(data.categories) && setCategories) {
      ...
      toast({
        title: "Success",
        description: isEditing ? "Timeline updated successfully" : "Timeline generated successfully",
      });
