...
export default function TimelinePage() {
  ...
  const { data: existingTimeline, isLoading } = useQuery<Timeline>({
  ...
  useEffect(() => {
    if (existingTimeline && id) {
      ...
      //Handle images here.  This is missing from the edited snippet.  Assuming TimelineImages component handles this.
    }
