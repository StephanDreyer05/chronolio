...
export default function ContactsPage() {
  ...
  const vendorTypes = settings?.contactTypes || []; // Use optional chaining and provide fallback
  ...
  const fetchVendors = async () => {
    try {
      setIsLoading(true);
      const response = await fetchWithAuth("/api/vendors");
      if (!response.ok) {
              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setSelectedTypeFilter(value)}
                  >
